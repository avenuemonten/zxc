...
# добавляем репозитории Astra Linux
        ...
        echo -e "deb http://dl.astralinux.ru/astra/frozen/1.7_x86-64/1.7.4/repositorymain 1.7_x86-64 main non-free contrib" | sudo tee /etc/apt/sources.list
        echo -e "deb http://dl.astralinux.ru/astra/frozen/1.7_x86-64/1.7.4/repositoryupdate 1.7_x86-64 main contrib non-free" | sudo tee -a /etc/apt/sources.list
